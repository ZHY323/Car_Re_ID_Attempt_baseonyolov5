...
if __name__ == '__main__':
    ...
    while True:
        ...
        if len(bboxes) > 0:
            ...
            output_image_frame = tracker.draw_bboxes(im, list_bboxs, line_thickness=None, rootpath=rootpath, stat_dic=stat_dic)
            pass
        else:
            # 如果画面中 没有bbox
